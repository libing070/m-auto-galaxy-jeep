<template>
  <div class="analysisdoubt">
    <div class="item">
      <div class="column">
        <span class="title">一级维度</span>
      </div>
      <div class="draw-group">
        <div class="draw" id="analysisdoubt1"></div>
      </div>
    ...
    <div class="item">
      ...
      <div class="draw small" id="analysisdoubt2" :style="{ height: '260px'}"></div>
    ...
    <div class="item">
      ...
      <div class="draw small" id="analysisdoubt3" :style="{ height: '260px'}"></div>
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      that.chidlrenParams['xType']="doubt";
      that.init();
      $(".analysispleased").on("click",'.column .btn',function () {
        $("#analysisdoubt1 .item").remove();
    ...
    methods: {
        ...
        var widthRate = 100/(groupLen+2.5);
         ...
         for(var k=1;k<=groupLen;k++){
           ...
           that.$echarts.init(document.getElementById($el+k)).on('click', function (params) {
              $("#analysisdoubt2 .item").remove();
              $("#analysisdoubt3 .item").remove();
      ...
      drawLine2($el,title){
        ...
        let analysisdoubt2 = that.$echarts.init(document.getElementById($el))
        analysisdoubt2.setOption({
          grid: {
            left: '3%',
            top:'8%',
            bottom:'4%',
        ...
        analysisdoubt2.off('click');
        analysisdoubt2.on('click', function (params) {
      ...
      drawLine3($el,title){
        ...
        // 基于准备好的dom，初始化echarts实例
        let analysisdoubt3 = that.$echarts.init(document.getElementById($el))
        analysisdoubt3.setOption({
          grid: {
            left: '3%',
            top:'8%',
            bottom:'4%',
        ...
        analysisdoubt3.off('click');
        analysisdoubt3.on('click', function (params) {
          that.currThirdBarActiveyAxisName=params.name;
